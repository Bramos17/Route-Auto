import json
from sales_rest.models import SalesPerson, SalesCustomer, Sales, AutomobileVO
...
class Tests(TransactionTestCase):
    ...
    def test_customer_list(self):
        SalesCustomer.objects.create(first_name="first", last_name="last", address="222 22nd Street", phone_number="222-222 2222")
    ...
    def test_customer_delete(self):
        customer = SalesCustomer.objects.create(first_name="first", last_name="last", address="222 22nd Street", phone_number="222-222 2222")
    ...
    def test_sales_list(self):
        ...
        customer = SalesCustomer.objects.create(first_name="first", last_name="last", address="111 1st Street", phone_number="111-111 1111")
        auto = AutomobileVO.objects.create(vin="1")
        Sales.objects.create(automobile=auto, salesperson=salesperson, customer=customer, price=1000)
    ...
    def test_sales_create(self):
        ...
        customer = SalesCustomer.objects.create(first_name="first", last_name="last", address="222 2nd Street", phone_number="222-222 2222")
    ...
    def test_sale_delete(self):
        ...
        customer = SalesCustomer.objects.create(first_name="first", last_name="last", address="333 3rd Street", phone_number="333-333 3333")
        auto = AutomobileVO.objects.create(vin="3")
        sale = Sales.objects.create(automobile=auto, salesperson=salesperson, customer=customer, price=1000)
